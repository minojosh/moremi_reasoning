...
def scrape_radiopaedia(query="teeth", page=1, scope="cases"):
    """
...
def load_existing_urls(filename="angiogram_case_urls.json"):
    """
...
def save_to_json(data, filename="angiogram_case_urls.json"):
    """
...
if __name__ == "__main__":
    ...
    dental_keywords = ['mammogram','mammography','breast','breast cancer']
